...
//program write by Mustaque Ahemmed
	...
	function calculatetotal($colomn){
		global $conn;
		$sqlfortotal="SELECT SUM($colomn) as totalsum FROM income";
        ...
        <div class="admin_area">
            <form action="" method="post">
                <table width="100%" border="1" cellpadding="5" cellspacing="0" class="table table-bordered table-hover table-striped table-condensed">
                    <tr>
                        <th style="background-color: #82ffa2" colspan="10" scope="col" class="text-center success">TOTAL BALANCE SHEET</th>
                    </tr>
 ...
 <?php
    if ($countrow>0) {
		while ($counter=mysqli_fetch_array($sqlquery)) {
            ?>
            <tr>
                <td><?php $counter['id']; echo $currentid=$counter['id']; ?></td> 
