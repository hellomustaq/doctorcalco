        ...
        <div class="admin_area">
            <form action="" method="post">
                <table width="100%" border="1" cellpadding="5" cellspacing="0" class="table table-bordered table-hover table-striped table-condensed">
                    <tr>
                        <th style="background-color: #82ffa2" colspan="12" scope="col" class="text-center success"><?php echo date('M Y')."...PATIENT LIST" ?></th>
                    </tr>
                    <tr style="background-color: #89f1e2">
                        ...
                        <th class="text-center info">FINAL COST</th>
    ...
    if ($countrow>0) {
		while ($counter=mysqli_fetch_array($sqlquery)) {   
            ...
            <tr>
                ...
                <td style="background-color: #ff5959"><?php echo $counter['due']; ?></td>
                <td>
                    <form action="<?php 
                        if ($counter['due']<=0) {
                            echo "";
        ...
        ?>
                    ...
                    <tr><td colspan="12" scope="col"></td></tr>
