...
//program write by Mustaque Ahemmed
	...
	if ($_SERVER["REQUEST_METHOD"]=="POST") {
        ...
        $sqlforgetid=mysqli_query($conn,"SELECT id from registerMember where name='$pname'and phone='$pphone' and address='$paddress' and thisdate = '$thisdate'");
 ...
 <head>
 	...
 	*{
	 ...
	 <body style="background-color: #f1ecb5;">
	 	...
	 	<h3 style="margin: 0;padding: 0;text-align: center;color: red;">Patient Details</h3><br>
	...
	<div class="formcon">
		<div class="formconinside">
		 ...
		 <div class="showercon">
			 <div class="shower">
			    <h2 style="color: #5c8fde;">Check your most resent entry..</h2>
			 	<table>
			 		<tr>
				 		<td>NAME: </td>
